...
#define IOCTL_XUSB_GET_XINPUT_MANAGEMENT_DRIVER /*0x80006380*/ CTL_CODE(FILE_DEVICE_XUSB, IOCTL_INDEX_XUSB + 224, METHOD_BUFFERED, FILE_READ_ACCESS)
#define IOCTL_XUSB_WAIT_FOR_SYSTEM_BUTTONS      /*0x8000E384*/ CTL_CODE(FILE_DEVICE_XUSB, IOCTL_INDEX_XUSB + 225, METHOD_BUFFERED, FILE_READ_ACCESS | FILE_WRITE_ACCESS)
